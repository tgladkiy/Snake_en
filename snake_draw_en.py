...
"""Module for rendering the playing field and statistics data"""
...
class Pole:
    ...
    def draw(self, window, arr):
        ...
        pygame.draw.rect(self.window, frame_color, (self.otstup,    #the game field frame
                                               self.otstup,
                                               self.pole_size,
    ...
    # Frame for the table 'families and epochs scores'
    ...
    # Data table for 'families and epochs scores'
    ...
    # Status or hotkeys information bar
